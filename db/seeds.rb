...
Category.create(name: 'beachfront')
Category.create(name: 'mansions')
Category.create(name: 'lakefront')
Category.create(name: 'amazing views')
Category.create(name: 'countryside')
Category.create(name: 'tiny homes')
Category.create(name: 'iconic cities')
Category.create(name: 'luxe')
Category.create(name: 'surfing')
Category.create(name: 'skiing')
Category.create(name: 'houseboats')
Category.create(name: 'desert')
Category.create(name: 'historical homes')
