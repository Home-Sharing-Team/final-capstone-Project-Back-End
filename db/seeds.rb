...
ann = User.create(name: 'Ann Brown', email: 'ann@test.com', password: '123123') # 6
...
alex = User.create(name: 'Alexander Owen', email: 'alex@test.com', password: '123123') # 9
...
glass_mansion_address = Address.create(street: 'Unknown', city: 'Osage Beach', country: 'United States', zip_code: '111112', number: 2, continent: 'North America') # id = 2

glass_mansion = Property.create(
  name: 'Iconic Glass Mansion - Huge Views - Best Location',
  description: 'The iconic and luxurious Glass Mansion has awe-inspiring, expansive lake views for miles from almost every room. It is located directly in the heart of Lake of the Ozarks in Osage Beach, yet is securely and privately tucked away in the prestigious gated Ledges Waterfront Homes neighborhood. Glass Mansion sits on the main channel of the lake directly on the water at the 20 mile marker, perched on beautiful natural rock cliffs with cascading waterfalls into the lake below.',
  guest_capacity: 16,
  bedrooms: 5,
  beds: 10,
  baths: 5,
...
PropertyCategory.create(property_id: 2, category_id: 4)
...
beachfront_address = Address.create(street: 'Unknown', city: 'Malibu', country: 'United States', zip_code: '111115', number: 5, continent: 'North America') # id = 3

beachfront = Property.create(
  name: 'Beachfront Malibu Retreat',
  description: 'AUTUM is the BEST TIME of year to visit Malibu! You can see the SUNRISE and the SUNSET from the deck, go swimming with the DOLPHINS in the morning and fall asleep to the sound of the ocean! My home is ideal for COUPLES or SOLO adult (over 25 ) travelers ONLY, maybe a dog.',
  guest_capacity: 2,
  bedrooms: 1,
  beds: 1,
  baths: 1,
...
PropertyImage.create(property_id: 3, source: 'https://i.ibb.co/P98xkTQ/56fe9e3f-48c1-4777-a2b0-5b7745eb9874.webp')
PropertyImage.create(property_id: 3, source: 'https://i.ibb.co/d5m1dSm/ad0164c8-acb5-477d-b1d0-19fabd9931cc.webp')
PropertyImage.create(property_id: 3, source: 'https://i.ibb.co/Fs7Zy8v/6861fc2a-ca6b-473a-b64d-7303f3836584.webp')
PropertyImage.create(property_id: 3, source: 'https://i.ibb.co/0n8T0MP/90f625f1-67e9-4a62-8e10-554ae12c8763.webp')
PropertyImage.create(property_id: 3, source: 'https://i.ibb.co/3FTr5tY/8ce69729-b8bd-41a4-83a5-383448dd0e80.webp')

PropertyCategory.create(property_id: 3, category_id: 2)
PropertyCategory.create(property_id: 3, category_id: 15)
PropertyCategory.create(property_id: 3, category_id: 5)
PropertyCategory.create(property_id: 3, category_id: 10)
...
songbird_address = Address.create(street: 'Unknown', city: 'Brewster', country: 'United States', zip_code: '111115', number: 6, continent: 'North America') # id = 4
...
PropertyImage.create(property_id: 4, source: 'https://i.ibb.co/3kPZW0f/3c0dfe9f-6df6-467a-9c80-4edbfe5dc61d.webp')
PropertyImage.create(property_id: 4, source: 'https://i.ibb.co/mByxRD3/b7079a51-dd6a-476a-b313-ba8589c534a0.webp')

PropertyCategory.create(property_id: 4, category_id: 6)
PropertyCategory.create(property_id: 4, category_id: 7)
...
provenza_address = Address.create(street: 'Unknown', city: 'Medellin', country: 'Colombia', zip_code: '111115', number: 7, continent: 'South America') # id = 5

provenza = Property.create(
  name: 'Provenza Life 1002- Gorgeus apartment/gym',
  description:
      'This special place is close to everything, making it easy to plan your visit and move around while enjoying your trip. Only has 1 AC in the main room',
  guest_capacity: 2,
  bedrooms: 1,
  beds: 1,
  baths: 2,
...
PropertyImage.create(property_id: 5, source: 'https://i.ibb.co/y4hsHMP/0451b654-545c-40e9-9416-458399129abf.webp')

PropertyCategory.create(property_id: 5, category_id: 8)
...
grand_castle_address = Address.create(street: 'Unknown', city: 'Grandville', country: 'United States', zip_code: '111115', number: 8, continent: 'North America') # id = 6
...
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/WFMLk4H/595b5f29-3b46-4441-aa67-a2be6939c84e.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/J7nfmdZ/f767ccad-eb79-404d-89e0-dd20ca8b3d96.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/zXGr9Hn/f71daedc-dc03-4ca0-b9c0-08fdbf0bf892.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/H45NzqM/ecf7de4b-7514-4414-8d87-352d4fcf1858.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/f1WZkqt/d6812963-84c2-4983-a483-ad53098376e9.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/nfhZc5W/c380a8fd-d6dc-48ee-b260-830853706221.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/Dw0GNn3/a3c208ff-4f1a-4567-9eab-d0319d55a21e.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/n3bgdVZ/366d8e94-7266-40e7-8ef1-606d6eb8ddd5.webp')
PropertyImage.create(property_id: 6, source: 'https://i.ibb.co/gjQsyKF/0ea037a4-20fc-480a-afc5-0f8837bc7821.webp')

PropertyCategory.create(property_id: 6, category_id: 16)
...
chateau_pessac_address = Address.create(street: 'Unknown', city: 'Pessac', country: 'France', zip_code: '111115', number: 9, continent: 'Europe') # id = 7
...
PropertyImage.create(property_id: 7, source: 'https://i.ibb.co/7rfyBrH/5cf60fda-63c1-45d3-84ad-e5c6f593f4af.webp')
PropertyImage.create(property_id: 7, source: 'https://i.ibb.co/stXcVM2/ac3a26b3-e9aa-4b6a-b40f-fe88b361c35b.webp')
PropertyImage.create(property_id: 7, source: 'https://i.ibb.co/KKGsVzG/fc0062e5-b322-4b65-993f-febffeaaffd3.webp')
PropertyImage.create(property_id: 7, source: 'https://i.ibb.co/xFqdcgS/c0c0b77c-0bc5-4836-af0b-fddabcdf8a08.webp')
PropertyImage.create(property_id: 7, source: 'https://i.ibb.co/JCY1gwB/3219f1c2-2778-440a-95db-48b4b4052c68.webp')
PropertyImage.create(property_id: 7, source: 'https://i.ibb.co/x6S4RSt/923dee3f-0509-4b85-b2e8-0fe4987cffa5.webp')
PropertyImage.create(property_id: 7, source: 'https://i.ibb.co/pnNJcQ7/682d90e6-b8df-493a-9f32-153b573456dc.webp')
