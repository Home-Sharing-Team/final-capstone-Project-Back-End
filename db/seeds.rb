...
Hosting.create(cycle: 1, minimum_cycle_amount: 1, rate: 1, public: true, cleaning_fee: 1, user_id: 43, property_id: 50)
Hosting.create(cycle: 2, minimum_cycle_amount: 2, rate: 12, public: true, cleaning_fee: 1, user_id: 44, property_id: 51)
...
Property.create(name: 'Casa 3', description: 'Casa 3', guest_capacity: 3, bedrooms: 3, beds: 3, bathrooms: 3, kind: 'apartment', address_id: 4, size: 3, user_id: 43)
